...
namespace App\Videographer\Service;
...
class VideographerService
{
    public function __construct(
        private readonly VideographerRepository $repository,
    ) {
    }
     ...
     */
    public function find(int $id): ?Videographer
    {
     ...
     */
    public function create(string $name, bool $active = true): Videographer
    {
     ...
     */
    public function update(Videographer $entity, ?string $name = null, ?bool $active = null): Videographer
    {
        if ($name !== null) {
            $entity->setName(trim($name));
        }
     ...
     */
    public function delete(Videographer $entity): bool
    {
        return $this->repository->deleteEntity($entity);
    }

    /**
     * Get image data for a videographer.
     */
     ...
     * @throws \Exception
     */
    public function uploadImage(Videographer $entity, UploadedFile $uploadedFile): Videographer
    {
        // Validate file size
